...
<head>
    ...
    @media print {
        ...
        /* Ensure kembalian is visible */
        .kembalian {
            visibility: visible !important;
        }

        /* Optionally hide non-relevant content during print */
        .no-print {
            display: none;
        }
    }
    ...
    <div class="container">
        <div class="center">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td class="text-start" colspan="3"><strong>Kembalian + Diskon:</strong></td>
                    <td class="text-end"><?php echo number_format($kembalian + $diskon, 2); ?></td>
                </tr>
            </table>
