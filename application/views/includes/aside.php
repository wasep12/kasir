             ...
             with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url('supplier') ?>"
                        class="nav-link <?php echo $uri == 'supplier' ? 'active' : 'no' ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url('pelanggan') ?>"
                        class="nav-link <?php echo $uri == 'pelanggan' ? 'active' : 'no' ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url('transaksi') ?>"
                        class="nav-link <?php echo $uri == 'transaksi' ? 'active' : 'no' ?>">
                    ...
                    <ul class="nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo site_url('laporan_penjualan') ?>"
                                class="nav-link <?php echo $uri == 'laporan_penjualan' ? 'active' : 'no' ?>">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li
                    class="nav-item has-treeview <?php echo $uri == 'peramalan' || $uri == 'peramalan_tahun' ? 'menu-open' : 'no' ?>">
                    <a href="#"
                        class="nav-link <?php echo $uri == 'peramalan' || $uri == 'peramalan_tahun' ? 'active' : 'no' ?>">
                        <i class="fas fa-chart-bar nav-icon"></i>
                        <p>Menampilkan Trend</p>
                        <i class="right fas fa-angle-right"></i>
                    </a>
                    <ul class="nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo site_url('peramalan'); ?>"
                                class="nav-link <?php echo $uri == 'peramalan' ? 'active' : 'no' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Trend Perbulan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('peramalan_tahun'); ?>"
                                class="nav-link <?php echo $uri == 'peramalan_tahun' ? 'active' : 'no' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Trend Pertahun</p>
                            </a>
                        </li>
